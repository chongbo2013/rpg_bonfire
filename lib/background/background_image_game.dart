...
class BackgroundImageGame extends GameBackground with UseSprite {
  ...
  final bool layerIsAbove;
  final bool layerIsNoParallax;
  ...
  BackgroundImageGame({
    ...
    this.layerIsAbove = false,
    this.layerIsNoParallax = true,
  ...
  void update(double dt) {
    super.update(dt);
    if (camera.position != _lastPosition&&!layerIsNoParallax) {
